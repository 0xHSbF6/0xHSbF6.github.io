...
![alt](/assets/img/posts/lovespouse-ble-reverse/wireshark-hci.png){: width="250" .center}
...
![alt](/assets/img/posts/lovespouse-ble-reverse/poc-control.png){: width="250" .center}
